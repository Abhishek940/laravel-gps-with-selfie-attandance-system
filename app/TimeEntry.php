...
class TimeEntry extends Model
{
    ...
    public function user()
    {
	 ...
	 public function timeEntrieUsers()
    {
        return $this->hasMany(TimeEntryUser::class);
    ...
    public static function boot() {
        parent::boot();
        self::deleting(function($timeentry) { // before delete() method call this
             $timeentry->timeEntrieUsers()->each(function($timeEntrieUsers) {
                $timeEntrieUsers->delete(); // <-- direct deletion
             });
